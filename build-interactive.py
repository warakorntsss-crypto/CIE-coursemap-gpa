...
Aesthetic: light educational graph-paper (white cards in category pastels,
blue prerequisite / amber unlock highlights; Lexend + JetBrains Mono).
...
.tools input[type=search]{background:#fff; border:1px solid var(--panel-line); color:var(--ink); font-family:"JetBrains Mono",monospace; font-size:12px; padding:8px 10px; border-radius:6px; width:150px}
.tools input::placeholder{color:#5f7187}
.btn{font-family:"JetBrains Mono",monospace; font-size:11px; letter-spacing:.5px; background:#fff; color:#44566b; border:1px solid var(--panel-line); padding:8px 11px; border-radius:6px; cursor:pointer; user-select:none; white-space:nowrap}
...
#summary .sh b{font-family:"Lexend",sans-serif; font-weight:700; text-transform:uppercase; letter-spacing:.8px; font-size:14px; color:#14233a}
...
<div class="hint">Click a course → it, its <b>prerequisites</b> &amp; what it <b>unlocks</b> glow. Click again → details.</div>
...
wireInfo.forEach(inf=>{
  ...
  let pts;
  if(span===1 && Math.abs(ay-by)<0.5){               // same row, slots aligned: straight line, no curve
    pts=[[sxR,ay],[txL,by]];
